...
/*!50001 VIEW `test1` AS select `land`.`countryName` AS `countryName`,`land`.`countryCode` AS `countryCode`,`land`.`emissionen` AS `emissionen`,`land`.`ID` AS `ID` from `land` where (`land`.`ID` between 1 and 99) */;
